...
const CategoryBanner = () => {
    return (
        <div className="category hero min-h-screen mt-20 bg-black">
            <div className="hero-content text-center">
                <div className="bg-opacity-70 flex items-center lg:h-[250px] w-3/4 bg-black">
                    <div className='lg:px-24 px-10 py-10 lg:py-0'>
                        <h1 className="mb-5 lg:text-5xl text-4xl font-bold uppercase text-blue-600">Job Category</h1>
                        <p className="mb-5 text-white text-justify leading-tight">
